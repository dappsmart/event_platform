...
import { getOrderedEventsByUser } from "@/lib/actions/order.actions";
...
const ProfilePage = async ({ searchParams }: SearchParamProps) => {
  ...
  const orderedEvents = await getOrderedEventsByUser({
    userId,
    page: ordersPage,
  });
  ...
  // const orderedEvents = await getOrdersByUser({ userId, page: ordersPage });
